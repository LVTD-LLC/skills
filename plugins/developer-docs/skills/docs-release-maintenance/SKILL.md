...
description: Manage developer documentation release, publishing, ownership, freshness, automation, maintenance, deprecation, deletion, redirects, and migration alongside software changes. Use when planning docs for a release, defining docs ownership, creating publishing checklists, setting up freshness checks, or retiring stale documentation.
license: MIT
...
This skill is derived from *Docs for Developers: An Engineer's Field Guide to Technical Writing*, especially Chapter 7, "Publishing documentation," and Chapter 11, "Maintaining and deprecating documentation." The guidance is transformed and paraphrased; do not copy book prose into user outputs. Source: https://link.springer.com/book/10.1007/978-1-4842-7217-6
...
4. Align doc publication, review, testing, announcement, and deprecation with code changes.
5. Prefer automation that removes known toil; do not automate an unclear process.
