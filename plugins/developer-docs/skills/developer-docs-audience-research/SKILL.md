...
description: Research developer documentation audiences by mapping user goals, business goals, developer traits, user questions, personas, user stories, journey maps, and friction logs. Use when planning docs for APIs, SDKs, platforms, CLIs, developer tools, onboarding guides, or support-heavy docs before writing or restructuring content.
license: MIT
...
3. Identify user goals, business goals, user traits, questions, and missing knowledge.
...
3. **User questions** - setup, concept, task, API, troubleshooting, and decision questions.
4. **Research artifacts** - persona, user story, journey map, or friction log entries when useful.
5. **Assumptions and gaps** - what is inferred versus verified.
6. **Validation plan** - the next interviews, data sources, or product walk-throughs.
...
- Let audience findings shape content type, order, depth, examples, and success metrics.
