...
Evidence: Crawl found zero internal inlinks; only XML sitemap includes URL.
...
Verification: Re-crawl and confirm internal inlinks.
```
...
| Indexability | Indexable canonical self or intended URL | noindex, blocked, canonical elsewhere |
...
- The asset is still staged or noindexed.
