# Docs Feedback Triage Guidelines
...
|-------------------|------------------|
| Triaging a docs feedback queue | `references/core/knowledge.md`, `workflows/triage-doc-feedback.md` |
...
|------------------|------------------|
| Feedback says "this is confusing" with no detail | `workflows/triage-doc-feedback.md` |
...
| `workflows/triage-doc-feedback.md` | Step-by-step workflow |
