...
1. Decide whether the idea should be a post, article, newsletter edition, or
   series.
2. Clarify goal, audience, topic territory, cadence, and reader benefit.
3. Draft long-form content that teaches, explains, or synthesizes rather than
   advertising.
4. Add a short bio, profile link or next step, and a post teaser when relevant.
5. Check current LinkedIn article/newsletter capabilities before giving
